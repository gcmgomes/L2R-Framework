...
for i in {1..5}; do
  ...
  echo "Running Fold $i..."
  mkdir -p random_forest/predictions/original/
...
for i in {1..5}; do
  ...
  echo "Running Fold $i..."
  mkdir -p random_forest/predictions/discretized_10_bins_tube/
...
for i in {1..5}; do
  ...
  echo "Running Fold $i..."
  mkdir -p random_forest/predictions/discretized_20_bins_uniform/
